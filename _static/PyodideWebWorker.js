...
async function loadApplication(cell_id, path) {
  ...
  const packages = LOCKFILE_PACKAGES.length ? [] : ['https://cdn.holoviz.org/panel/wheels/bokeh-3.9.2-py3-none-any.whl', 'https://cdn.holoviz.org/panel/wheels/panel-1.9.4-py3-none-any.whl', 'pyodide-http'];
  if (path != null) {
